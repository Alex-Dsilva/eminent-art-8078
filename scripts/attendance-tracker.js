...
let setimg=(ele)=>{
    ...
    if(ele=="btn1"){
        changeableimg.src="https://trackingtime.co/wp-content/uploads/2020/05/Attendance-bot-ilus-01-2.svg"
    }else if(ele=="btn2"){
        changeableimg.src="https://trackingtime.co/wp-content/uploads/2020/05/Attendance-bot-ilus-02-1.svg"
    }else if(ele=="btn3"){
        changeableimg.src="https://trackingtime.co/wp-content/uploads/2020/05/Attendance-bot-ilus-03.svg"
    }
